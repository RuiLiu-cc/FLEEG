...
def Weibo2014_fetchfiles(saveNpzPath, chans=None, downsampleFactor=1):
...
def preprocessing_Weibo2014_dataset(saveNpzPath, saveFilteredPath, chans, downdampleFactor, bandFiltCutF, filterType, resample):

    # check if the original file exists or fetch it.
    if not os.path.exists(saveNpzPath):
        os.makedirs(saveNpzPath)
        Weibo2014_fetchfiles(saveNpzPath, chans=chans, downsampleFactor=downdampleFactor)
...
if __name__ == '__main__':
    ...
    saveNpzPath = r'/path/to/Original_data/Weibo2014'
    saveFilteredPath = r'/path/to/filtered_data/Weibo2014'
    ...
    preprocessing_Weibo2014_dataset(saveNpzPath, saveFilteredPath, chans, downdampleFactor, bandFiltCutF, filterType, resample)